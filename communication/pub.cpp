...
int main(int argc, char **argv) {
    ...
    auto publisher = session.declare_publisher(KeyExpr("demo/example/simple"));
        ...
        publisher.put(std::move(b1));
         Bytes b2 = ext::serialize(s2);
        publisher.put(std::move(b2));
         Bytes b3 = ext::serialize(s3);
        publisher.put(std::move(b3));
         Bytes b4 = ext::serialize(s4);
        publisher.put(std::move(b4));
         Bytes b5 = ext::serialize(m);
        publisher.put(std::move(b5));
         Bytes b6 = ext::serialize(s5);
        publisher.put(std::move(b6));
