...
struct QuadrupedMeasurementData {
    vec3 base_position;
      ...
      {//try
      {
        /* code */
           ...
           std::cout << "Received data:" << std::endl;
            ...
            QuadrupedSensorData s1 = ext::deserialize<QuadrupedSensorData >(sample.get_payload());
          //  std::cout << "QuadrupedSensorData: " << s1 << std::endl;
            ...
            QuadrupedCommandData s3 = ext::deserialize<QuadrupedCommandData >(sample.get_payload());
            std::cout << "QuadrupedCommandData: " << s3 << std::endl;
            QuadrupedPlannerData s4 = ext::deserialize<QuadrupedPlannerData >(sample.get_payload());
             std::cout << "QuadrupedPlannerData: " << s4 << std::endl;
            //QuadrupedMeasurementData m = ext::deserialize<QuadrupedMeasurementData >(sample.get_payload());
            //std::cout << "QuadrupedSensorData: " << s1 << std::endl;
            QuadrupedJoystickData s5 = ext::deserialize<QuadrupedJoystickData >(sample.get_payload());
